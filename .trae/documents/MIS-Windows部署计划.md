...
| 组件 | 版本要求 |
|------|----------|
| 后端框架 | PHP 8.5.4 + CodeIgniter 4.7.2 |
| 前端框架 | Node.js 25.9.0+ + Vue 3 + Vite |
| 包管理器 | pnpm 10.33+ |
| 数据库 | MySQL 8.0+ |
| Web服务器 | Apache 2.4+ |
...
2. 安装 Node.js：
   ```powershell
   choco install nodejs --version=25.9.0 -y
   ```
...
4. 验证安装：
   ```powershell
   git --version
   node --version  # 应显示 v25.9.0 或更高
   pnpm --version  # 应显示 10.33.0 或更高
   ```
...
**目标**：安装 PHP 8.5.4 并配置 Apache 模块

**步骤**：
1. 下载 PHP 8.5.4：
   - 访问：https://windows.php.net/download/
   - 下载：VS17 x64 Thread Safe 版本
   - 或 Zip 版本：php-8.5.4-Win32-vs17-x64.zip
...
8. 验证：
   ...
   <?php phpinfo(); ?>
   ```
   - 浏览器访问 http://localhost/info.php，应显示 PHP 8.5.4 信息
...
| PHP | 8.5.4 | https://windows.php.net/download/ |
| MySQL | 8.4.2 | https://dev.mysql.com/downloads/installer/ |
| Node.js | 25.9.0 | https://nodejs.org/ 或 choco |
| pnpm | 10.33.0 | npm install -g pnpm |
| Composer | 2.9.5 | https://getcomposer.org/ 或 choco |
